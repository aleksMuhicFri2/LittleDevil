...
public class StartScreen implements Screen {
    ...
    private Texture backgroundTexture, titleTexture, playButtonTexture, candleSheet, particleSheet;
    private Sound difficultySound, playSound;
    ...
    private float lessScale = 1f, moreScale = 1f, playScale = 1f;
    ...
    private final Color redColor = new Color(1f, 0.24f, 0.24f, 1f);
    ...
    private final Color completionGold = new Color(1f, 0.84f, 0.0f, 1f);
    ...
    private static class Particle {
        ...
        public boolean isOffScreen() { return x > 1920f + 50; }
    }
